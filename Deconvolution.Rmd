...
\begin{align}\hat{x}_i &= C_i(n_i-\beta_i) \nonumber\\ &= C_iy_i\label{eq:bin1}\end{align}

\begin{align}C_i = \frac{x_i^{\text{MC}}}{y_i^{\text{MC}}}\label{eq:bin2}\end{align}

\begin{align}E_i[\hat{x}_i] &= C_iE[n_i-\beta_i] \nonumber\\ &= \frac{x_i^{\text{MC}}}{y_i^{\text{MC}}}y_i \nonumber &=  \label{eq:bin3}\end{align}
